 ...
 D_FRACTION_WEST_CFG = [
	[
		'CUP_B_USMC', 'USMC', [
			...
			['Company comander', 'CUP_B_FR_Commander'],
			['Dep. Company commander', 'CUP_B_FR_Story_OHara'],
			['Chief Corpsman', 'CUP_B_USMC_Medic'],
			['Team Leader', 'CUP_B_USMC_Soldier_TL'],
			['Corpsman', 	'CUP_B_USMC_Medic'],
			['Paramedic', 	'CUP_B_USMC_Medic'],
			['Grenadier', 	'CUP_B_USMC_Soldier_GL'],
			['Rifleman', 	'CUP_B_USMC_Soldier_LAT'],
			['Pilot', 	'CUP_B_USMC_Pilot'],
			['Engineer', 	'CUP_B_USMC_Engineer'],
			...
			['rescue_Squad Leader',  'CUP_B_FR_Commander'],
			['rescue_Corpsman', 	'CUP_B_FR_Medic'],
			['rescue_Paramedic', 	'CUP_B_FR_Medic'],
			['rescue_Engineer', 	'CUP_B_USMC_Engineer'],
			['rescue_Grenadier', 	'CUP_B_FR_Soldier_Assault_GL'],
			['rescue_Rifleman', 	'CUP_B_FR_Soldier_Assault'],
			['rescue_Pilot', 	    'CUP_B_USMC_Pilot'],
			['rescue_Squad Leader', 'CUP_B_FR_Soldier_TL'],
			['rescue_Autorifleman', 'CUP_B_FR_Soldier_AR'],
			['rescue_Company comander', 'CUP_B_FR_Commander'],
			['rescue_Dep. Company commander', 'CUP_B_FR_Story_OHara'],
			['rescue_Chief Corpsman', 'CUP_B_USMC_Medic'],
 ...
 D_FRACTION_EAST_CFG = [
	[
		'CUP_O_SLA', 'Sahrani Liberation Army', [
			...
			['Company commander', 'CUP_O_sla_Commander'],
			['Dep. Company commander', 'CUP_O_sla_Officer'],
			['Chief Corpsman', 'CUP_O_sla_Medic'],
			['Team Leader', 'CUP_O_sla_SpecOps_TL'],
			['Corpsman', 	'CUP_O_sla_Medic'],
			['Paramedic', 	'CUP_O_sla_Medic'],
			['Grenadier', 	'CUP_O_sla_SpecOps'],
			['Rifleman', 	'CUP_O_sla_SpecOps'],
			['Engineer', 	'CUP_O_sla_Engineer'],
			['Pilot', 	'CUP_O_sla_Pilot'],
			['Rifleman (RPK)', 	'CUP_O_sla_Soldier_AR'],
