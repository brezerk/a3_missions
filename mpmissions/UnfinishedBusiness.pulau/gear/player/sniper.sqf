...
_this addPrimaryWeaponItem "CUP_optic_Leupold_VX3";
_this addPrimaryWeaponItem "CUP_10Rnd_127x99_M107";
...
for "_i" from 1 to 3 do {_this addItemToUniform "CUP_10Rnd_127x99_M107";};
_this addItemToVest "ACE_Canteen";
for "_i" from 1 to 2 do {_this addItemToVest "CUP_10Rnd_127x99_M107";};
