...
if (hasInterface) then {
	Fn_Local_Create_Mission_CrashSite = {
		...
		_trg setTriggerStatements [
			...
			"[ format [localize 'INFO_LOC_01', D_LOCATION], localize 'INFO_SUBLOC_01', format [localize 'INFO_DATE_01', daytime call BIS_fnc_timeToString], mapGridPosition player ] spawn BIS_fnc_infoText;",
			""
		];
