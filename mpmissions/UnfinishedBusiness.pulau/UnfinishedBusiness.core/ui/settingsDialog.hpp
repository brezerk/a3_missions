...
{
	idd = 3773;
	onUnload = "params ['_display', '_exitCode']; [_exitCode] execVM 'UnfinishedBusiness.core\ui\SettingsDialog.sqf';";
	...
	class Controls
	{
		...
		class bntStart : RscButton 
		{
			...
			action = "execVM 'UnfinishedBusiness.core\ui\applySettings.sqf';";
