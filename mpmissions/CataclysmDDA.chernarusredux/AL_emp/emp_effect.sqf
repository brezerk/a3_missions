...
//{_x setHitPointDamage ["hitEngine",1]; _x disableTIEquipment true; _x disableNVGEquipment true; [[_x],"AL_emp\tgt_sfx.sqf"] remoteExec ["execVM"]; sleep _delay_check} forEach list_car_emp;
...
[] spawn 
	{
		...
		["strigat_92"] remoteExec ["playsound"];
