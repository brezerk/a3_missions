...
player addItemToUniform "CL_Antidote";
player addItemToUniform "ACE_EarPlugs";
...
player addItemToUniform "CL_PainKillers";
player addItemToBackpack "ToolKit";
player addItemToBackpack "ACE_EntrenchingTool";
player addItemToBackpack "CL_Axe";
player addItemToUniform "CL_Matches";
player addItemToBackpack "CL_GasMask_03";
player addItemToUniform "ChemicalDetector_01_watch_F";
