...
supply_box_02 addAction ["Стрілок (Rifleman)", {player call compile preprocessFileLineNumbers "gear\player\rifelman_light.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Стрілець-санітар (Combat medic)", {player call compile preprocessFileLineNumbers "gear\player\medic.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Інженер (Engineer)", {player call compile preprocessFileLineNumbers "gear\player\engineer.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Кулеметник (Machine Gunner)", {player call compile preprocessFileLineNumbers "gear\player\mg.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Помічник Кулеметника (Machine Gunner Assistant)", {player call compile preprocessFileLineNumbers "gear\player\mg_assist.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Гранатометник (Grenadier RPG-7)", {player call compile preprocessFileLineNumbers "gear\player\pt.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Помічник Гранатометника (Grenadier Assistant)", {player call compile preprocessFileLineNumbers "gear\player\pt_assist.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Влучний стрілець (Marksman)", {player call compile preprocessFileLineNumbers "gear\player\marksman.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Заступник командира (Dep. Squad leader)", {player call compile preprocessFileLineNumbers "gear\player\rifelman_light.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];
supply_box_02 addAction ["Командир (Group leader)", {player call compile preprocessFileLineNumbers "gear\player\commander.sqf"; [player, [missionNamespace, "outpost_saved_loadout"]] call BIS_fnc_saveInventory;}];


['Україна. Зона АТО.', 'Позиції біля міста Сумма', format ['16 жовтня 2019 %s', daytime call BIS_fnc_timeToString], mapGridPosition player ] spawn BIS_fnc_infoText;