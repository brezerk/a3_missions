...
for "_i" from 1 to 10 do {_this addItemToBackpack "ACE_bloodIV";};
for "_i" from 1 to 50 do {_this addItemToBackpack "ACE_fieldDressing";};
for "_i" from 1 to 20 do {_this addItemToBackpack "ACE_epinephrine";};
for "_i" from 1 to 30 do {_this addItemToBackpack "ACE_morphine";};
